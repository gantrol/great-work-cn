...
如果他们关注的东西是他们不太理解的，这些新的想法可能并不好。一位男士在离婚后决定花心思在约会上，他是我认识的最具原创性的思考者之一，但他对约会的了解大概跟十五岁小孩一样，而结果是“引人注目、丰富多彩”的[^colorful]。看到原创性如此与专业技能脱钩，它的本质则更为清晰。

我不知道是否可以培养原创性，但肯定可以充分利用你现有的。例如，当你在钻研时，你更有可能产生原创的想法。原创的想法不能光靠想来产生，而是要靠构建或理解有点太难的东西。[^15]
...
不过，不要在许多主题上**均匀**分配你的注意力，否则会把精力分得太薄。你需要按照更像幂律的分布来分配。[^17] 专业地在少数几个主题求知，随意地在许多其他主题求知。
...
产生新想法是一种奇怪的游戏，因为它通常由你眼前的事物构成。一旦你看到了一个新想法，它就会显得很明显。为什么之前没有人想到这个呢？

如果一个想法显得新颖且明显，那么它很可能是个好想法。

看到某个显眼的东西，听起来很容易。然而，从经验上看，产生新想法是很难的。这种明显矛盾的源头在哪里呢——看到新的想法通常需要你改变看世界的方式。我们通过模型来看世界，这些模型既帮助我们、也约束我们。当你修复一个有误模型时，新的想法就变得明显。但是，注意到并修复一个有误模型是困难的。这就是新想法既显而易见又难以发现的原因：你要历经困难，它们才容易被看到。
...
当你临摹一样东西时，不要临摹它的每一个特征。如果你临摹有些特征的话，会让你看起来很可笑。例如，如果你18岁，不要模仿一位50岁的著名教授的行为举止，或者复制几百年前文艺复兴诗歌的语言。
