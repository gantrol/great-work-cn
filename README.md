...
宗教是一系列被珍视但错误的原则的集合。任何可以被字面上或比喻地描述为宗教的东西，都会在它的阴影中有未被探索的有价值的想法。哥白尼和达尔文都发现了这种类型的想法。[^18]
...
最有趣的一种不时髦的问题是，人们认为已经被充分探索过，但实际上没有。“大事”往往依赖已经存在的事物，并展现事物潜在的潜力。杜勒尔和瓦特都做到了这一点。如果你对别人认为已经被研究透的领域感兴趣，不要让他们的怀疑阻挡你。人们经常对此有错误的认识。
...
计划本身并不好。有时候它是必要的，但只是因为没有更好的选择 —— 容错率低，你不得不这样做。可能是因为你在使用不灵活的媒介，或者需要协调很多人力[^evil]。如果你能把项目保持小而且使用灵活的媒介，你就不需要做太多计划，你的设计可以迭代演进。
...
有好的临摹方式，也有坏的。如果你要临摹，那就公开地做，而不是秘密地做，更不用说无意识地做了。这就是那句被误传的名言“伟大的艺术家剽窃”的意思。真正危险的临摹类型、那种给临摹带来坏名声的类型，是那种在不知情的情况下进行的临摹，你不过是在别人铺设的轨道上行驶的火车。但在另一个极端，临摹代表更优，而不是从属。[^25]
...
奇怪的是，最新颖的想法的新奇性，有时使它们看起来比实际上更缺乏独创性。新的发现往往要先被视为现有事物的变种，**甚至他们的发现者也要这样**，因为还没有概念词汇来表达这些发现。
