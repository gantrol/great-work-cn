...
一旦你找到了你“超级好奇”的东西，下一步就是学习足够的知识，使你能够接触到知识的前沿。知识的拓展方式就像地图海岸线的[^fractal]，从远处看，它的边缘看起来很平滑，而一旦你学习足够多，接近其中一个边缘，你就会发现它充满了缺口。[^new]

![不同衡量尺度下英国海岸线长度天差地别](assets/Coast_of_Britain.png)

下一步就是注意到这些缺口。这需要一些技巧，因为大脑希望忽略这些缺口，以便构建一个更简单的世界模型。许多发现的来源是，质疑大家以为理所当然的事情。[^2]
...
- 可能是因为，对于抱负来说，几乎所有错误都会使你离目标更远 —— 几乎所有偏离目标的炮弹都是差了一点；
- 可能是因为，想要成为最佳的抱负，跟只是想要变得更好，在质量上有差异；
...
对年轻人来说，成为别人的诱惑最大。他们常常觉得自己是无名小卒。但你永远不需要担心这个问题，因为如果你手头的项目足够有抱负，这个问题就会迎刃而解。如果你在一个雄心勃勃的项目上取得成功，你就不是无名小卒 —— 你就是那个干成事情的人。因此，专心办事，而身份问题自解。
...
可能有一些工作，在这些工作中，愤世嫉俗和悲观有优势，但是如果你想“干大事”，乐观有优势，尽管有时候会被当做傻瓜。有一个相反的传统，《旧约全书》说，最好保持安静，以免被当傻瓜[^fool]。但那是为了**看起来**聪明的建议，而如果你真的想发现新事物，最好冒着这个风险，告诉人们你的想法。

有些人天生就诚挚，而另一些人需要有意努力。这些都行。但我怀疑，如果不诚挚，就不可能“干大事”。不诚挚太难了——你没有容错的余地，来自于做作、智识上的不诚实、遵循传统、追求时尚或者酷的错误。[^14]
...
当然，仅仅真实还不够。伟大的想法必须真实且新颖。而即使你已经学习到足够的知识，走到知识的前沿，发现新想法仍需要一定的能力。
...
如果他们不太理解他们关注的东西，这些新的想法可能并不好。一位男士在离婚后决定花心思在约会上，他是我认识的思考者，很有原创性，但他对约会的了解大概跟十五岁小孩一样，而约会结果是“引人注目、丰富多彩”的[^colorful]。看到原创性如此跟专业技能脱钩，它的本质则更为清晰。
...
看到某个显眼的东西，听起来很容易。然而，从经验上看，很难产生新想法。这种明显矛盾的源头在哪里呢？在于看到新的想法通常需要你改变看世界的方式。我们通过模型来看世界，这些模型既帮助我们、也约束我们。当你修复一个有误模型时，新的想法就变得明显。但是，很难注意到并修复一个有误模型。这就是新想法既显而易见又难以发现的原因：你要历经困难，它们才容易被看到。
...
如果你仔细思考，那么你会发现，对大多数人来说，一个好的新想法都必须看起来很糟糕，否则早已有人做过了。你要找的是那些看起来疯狂，但正确地疯狂的想法。你怎么分辨呢？你不能确定。通常看起来糟糕的想法就是糟糕的。但是正确类型的疯狂的想法往往令人兴奋；它们富含含义；而那些只是糟糕的想法往往会让人沮丧。
...
严格性加上打破规则听起来像是一个奇怪的组合。在流行文化中，它们对立。但在这方面，流行文化的模型有误。它隐含地假设了问题微不足道，而在微不足道的问题中，严格性和打破规则对立。但在真正重要的问题中，只有打破规则的人才能真正严格。

## 14 被忽视的想法

一个被忽视的想法通常在“半决赛”中才会失利。你确实在潜意识中看到它，但是你的另一部分潜意识将其击败，因为它可能会太奇怪，太冒险，太辛苦，太有争议。这暗示了一个令人兴奋的可能性：如果你能关闭这样的过滤器，你就能看到更多的新想法。

实现这一点的一种方法是，询问对**其他人**来说，什么样的想法值得探索。然后你的潜意识就不会为了保护你而排除它们。
...
人们在解决问题上显示出的创新性远超于在决定解决哪些问题时。即使最聪明的人在决定要研究什么时，也可能惊奇地保守。那些在其他任何方式上都不会梦想追逐潮流的人，却被吸引到去解决时髦的问题上。
...
实际专业知识跟公众对它的看法极不相同。公众看来，专家十分有把握。但实际上，你越困惑，越好，只要 (a) 这事重要，并且 (b) 其他人也不理解它们。
...
为了“干大事”，你要怎样从小事做起呢？通过发布持续的版本。“大事”几乎总要靠持续的版本来完成。你开发出一个小东西，然后让它逐步演化，最终的版本会比你所能计划的都更聪明和有抱负。
...
不要想象自己要依赖于某个“掌门人”给你一个“大机会”。即使它可能正确，得到它的最好方式也是专注于做事，而不是追逐有影响力的人。
...
寻找最好的同事。有很多项目无法独立完成，即使你正在进行的项目可以独立完成，其他人也能给你鼓励、跟你交换想法。
...
受众是斗志的关键组成部分。如果你是学者，受众可能是同行；在艺术领域，受众可能是传统意义上的。无论哪种，受众都不需要太多。受众的价值并非线性增长。这对于名人来说是个坏消息，但对于刚刚起步的人来说是个好消息，这意味着小而专的受众就足以支持你。如果有一小部分人真心热爱你所做的事，那就足够了。
...
最终，斗志基于物质。你用你的身体思考，所以照顾好它非常重要。这意味着要定期运动，吃得好，睡得好，避免使用更危险的类型的药物。因为跑步和步行有利于思考，所以这种运动形式特别好。[^29]
...
求知欲是最佳指南。你的求知欲永远不会说谎，而且它比你更知道哪些事情值得关注。
...
信不信由你，我尽力让这篇文章尽可能短[^short]。但它的长度至少起到了过滤作用。如果你看到了这里，你肯定对“干大事”感兴趣。如果是这样，你已经比你可能意识到的更进一步，因为愿意去做的人的集合很小。
...
[^frauds]: 译注：原文是 eminent frauds。“Eminent” 通常是指在某个领域里有着很高声望或者被广泛认可的。“Frauds” 则是指欺骗或者不真实的事物。所以 “eminent frauds” 可以被理解为一些被社会广泛接受或者赞扬，但实际上可能并不真实或者并不值得追求的观念或者理念。
