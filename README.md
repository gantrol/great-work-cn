...
你也可以研究另一个方法：从遮挡物开始。有些原则被珍视却错误，在它们周围，都有一片死角，死角里充斥着有价值的想法。因为它们跟某个原则相矛盾，所以未被探索。

宗教是原则集合，这些原则被珍视但错误。任何可以被字面上或比喻地描述为宗教的东西，都会在它的阴影中有未被探索的有价值的想法。哥白尼和达尔文都发现了这种类型的想法。[^18]
