...
如果他们关注的东西是他们不太理解的，这些新的想法可能并不好。一位男士在离婚后决定花心思在约会上，他是我认识的思考者，很有原创性，但他对约会的了解大概跟十五岁小孩一样，而约会结果是“引人注目、丰富多彩”的[^colorful]。看到原创性如此与专业技能脱钩，它的本质则更为清晰。
...
产生新想法是一种奇怪的游戏，因为它通常由你眼前的事物构成。一旦你看到了一个新想法，它就会显得很明显。为什么之前没有人想到呢？

如果一个想法显得新颖而明显，那么它很可能是个好想法。

看到某个显眼的东西，听起来很容易。然而，从经验上看，产生新想法是很难的。这种明显矛盾的源头在哪里呢？在于看到新的想法通常需要你改变看世界的方式。我们通过模型来看世界，这些模型既帮助我们、也约束我们。当你修复一个有误模型时，新的想法就变得明显。但是，注意到并修复一个有误模型是困难的。这就是新想法既显而易见又难以发现的原因：你要历经困难，它们才容易被看到。
...
很少有人理解选择问题有多关键。其中一个原因是误解了问题与答案的比例。人们认为好想法都在答案里，但真洞见往往在问题中。

另一个原因是学校里用问题的方式。在学校里，问题往往只存在一段很短的时间，然后就得到了答案，就像不稳定的粒子。但是一个真正好的问题可以远不止于此。一个真正好的问题就是发现的一部分。新的物种是如何产生的？使物体落向地面的力和使行星保持在轨道上的力一样吗？仅仅提出这样的问题，你就已经进入了令人兴奋的新领域。
...
这是实际专业知识与公众对其的看法极不相同的地方。在公众的看法中，专家是十分有把握的。但实际上，你越困惑，越好，只要 (a) 你困惑的事情是重要的，并且 (b) 其他人也不理解它们。
